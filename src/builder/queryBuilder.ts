...
class QueryBuilder<T> {
  ...
  filter(): this {
    ...
    // Guard against NoSQL/operator injection: drop any key that starts with "$"
    // or contains ".", and reject values that are objects containing operator keys
    // (e.g. ?role[$ne]=USER). Only plain scalar equality filters are allowed.
